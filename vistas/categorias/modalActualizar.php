    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmActualizarCategoria">
          <input type="text" name="" id="idCategoria" hidden="">
          <label for="nombreCategoriaU">Nombre</label>
          <input type="text" id="nombreCategoriaU" name="nombreCategoriaU" class="frm-control">
          <hr>
          <label form="descripcionU">Descripcion</label>
          <textarea id="descripcionU" name="descripcionU" class="form-control"></textarea>
          
        </form>
      </div>
      <div class="modal-footer" >
        <button type="button" class="btn btn-warning" onclick="actualizarCategoria()">Actualizar</button>
